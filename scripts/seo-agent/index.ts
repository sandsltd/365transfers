...
async function main() {
  ...
  try {
    console.log("=== 365 Transfers SEO Agent ===\n");
    ...
    publishToMain(
      finalStrategy,
      blogPost ? blogPost.slug : null,
      blogPost ? blogPost.title : null,
      blogPost ? blogPost.description : null,
      blogPost ? blogPost.category : null,
      blogPost ? blogPost.date : null,
